...
import com.coder.community.utils.RedisKeyUtil;
...
public class LoginController implements CommunityConstant {
    ...
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code) {
        ...
        if (result == ACTIVATION_SUCCESS) {
            model.addAttribute("msg", "激活成功，您可以正常使用账户");
    ...
    @GetMapping("/kaptcha")
    public void getKaptcha(HttpServletResponse response/*, HttpSession session8 */) {
        // 生成验证码
...
//        将验证码存入redis
        ...
        String redisKey = RedisKeyUtil.getKaptchaKey(kapthaOwner);
...
//        String kaptcha = (String) session.getAttribute("kaptcha");
        ...
        if(kaptcha==null|| StringUtils.isBlank(code)||!kaptcha.equalsIgnoreCase(code)){
